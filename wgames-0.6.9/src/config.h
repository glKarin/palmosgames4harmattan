...
#ifndef _DBG
    #define BASE_DIR "/usr/share/wgames"
    #define TAR_APP "/usr/share/wgames/tar"
#else
    #define BASE_DIR "./data"
    #define TAR_APP "./data/tar"
#endif
#else
...
#else
#define DESKTOP_ENTRY_PATH USER_DIR"/.local/share/applications/"
#define ICONS_PATH USER_DIR"/.local/share/icons/hicolor/scalable/apps/"
#endif
